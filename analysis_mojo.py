"""Mojo KNN — 4-Variant Internal Comparison
...
plt.tight_layout()
plt.savefig('analysis_mojo.png', dpi=150, bbox_inches='tight')
print("Plot saved to analysis_mojo.png")
plt.show()
